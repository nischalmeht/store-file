      ...
      <AlertDialogContent className=" space-y-4 max-w-[95%] sm:w-fit rounded-xl md:rounded-[30px] px-4 md:px-8 py-10 bg-white outline-none">
        ...
        <InputOTP maxLength={6} value={password} onChange={setPassword}>
          <InputOTPGroup className="w-full flex gap-1 sm:gap-2 justify-between">
            ...
            <InputOTPSlot index={2} className="ext-[40px] font-medium rounded-xl ring-brand shadow-drop-1 text-brand-100 justify-center flex border-2 border-light-300 size-12 md:size-16 gap-5 " />
        ...
        <AlertDialogFooter>
          <div className="flex w-full flex-col gap-4">
            <AlertDialogAction
              ...
              className="bg-[#FA7275] button hover:bg-[#FA7275]-100 transition-all rounded-full h-12"
              type="button"
            >
              Submit
              {isLoading && (
